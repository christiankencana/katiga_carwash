<footer class="bg-light mt-auto">
    <div class="container-fluid">
        <div class="d-flex align-items-center justify-content-between small">
            ...
            <!-- Copyright &copy; Katiga Carwash - <?php echo date("Y");?> -->
            </div>
            <div>
...
<script src="https://cdn.datatables.net/fixedheader/3.1.9/js/dataTables.fixedHeader.min.js" crossorigin="anonymous"></script>
...
<script src="https://cdn.jsdelivr.net/gh/plentz/jquery-maskmoney@master/dist/jquery.maskMoney.min.js" crossorigin="anonymous"></script>
