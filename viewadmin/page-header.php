    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark shadow">
        <div class="container-fluid">
            <a class="navbar-brand bg-dark" href="#">
                <img src="../resources/img/logo.png" alt="" width="30" height="24" class="d-inline-block align-text-top">
                Katiga Carwash
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <ul class="navbar-nav text-nowrap">
                    <li class="nav-item">
                        <a class="nav-link px-3" href="account.php" tabindex="-1" aria-disabled="true">Account</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link px-3" href="../config/logout.php">Logout</a>
                    </li>
                </ul>
                <!-- <form class="d-flex">
