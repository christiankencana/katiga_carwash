<?php
    ...
    $types = $stmt->fetchAll();
?>
<div class="modal fade" id="kendaraan_add" tabindex="-1" role="dialog" aria-labelledby="kendaraan_add" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="../app/listkendaraan_add.php" method="post" enctype="multipart/form-data">
                    <div class="form-group mb-3 row">
                        <label class="col-sm-3 col-form-label">Nama Kendaraan</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="nama_kendaraan" value="" required>
                        </div>
                    </div>
                    <div class="form-group mb-3 row">
