...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
    <script type="text/javascript">
        function info_success(){
            swal.fire({
                icon: "success",
                text: "Tambah Kendaraan Berhasil!",
                type: "success",
                timer: 2000,
        ...
        function info_failed(){
            swal.fire({
                icon: "error",
                text: "Data Error/Nama Kendaraan Sudah Ada !",
                type: "error",
                timer: 5000,
                timerProgressBar: true,
            })
...
$query = "INSERT INTO list_kendaraan (nama_kendaraan, type_id, customers_id) VALUES (:a,:b,:c);";
    $query_params = array( 
        ':a' => $nama_kendaraan,
        ':b' => $type_id,
        ':c' => $customers_id,
